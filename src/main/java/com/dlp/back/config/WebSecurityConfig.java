    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> {
                    auth.requestMatchers("/", "/login/**","/auth/google/callback","/auth/kakao/callback","/images/**","/swagger-ui/**","/api-docs/**","/api*","/v3/api-docs/**", "/swagger-resources/**","/auth/send-code","/auth/verify-code","/api/v1/chatRoom/**","/api/v1/character/**", "/chatMessage/getMsgImg/**").permitAll();
